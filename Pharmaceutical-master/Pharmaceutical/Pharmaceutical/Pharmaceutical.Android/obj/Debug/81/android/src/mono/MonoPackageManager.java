...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Pharmaceutical.Android.dll" comes first in this list. */
		"Pharmaceutical.Android.dll",
		"DevExpress.Mobile.Core.Android.v18.1.dll",
		"DevExpress.Mobile.Core.v18.1.dll",
		"DevExpress.Mobile.Grid.Android.v18.1.dll",
		"DevExpress.Mobile.Grid.v18.1.dll",
		"FormsViewGroup.dll",
		"Newtonsoft.Json.dll",
		"SQLite-net.dll",
		"SQLite.Net.dll",
